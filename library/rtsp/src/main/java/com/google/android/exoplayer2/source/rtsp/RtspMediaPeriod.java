        ...
        synchronized (this) {
            ...
            if (preparedSampleStreamWrappers.length > 0) {
                ...
                eventDispatcher.loadError(null,
                        DATA_TYPE_MEDIA_INITIALIZATION, 0, null, 0, null, 0, 0, null, false);
            }
        }
    }
    ...
    public void onMediaStreamPlaybackCancel(RtspSampleStreamWrapper sampleStream) {
        synchronized (this) {
            ...
            if (preparedSampleStreamWrappers.length == 0) {
                ...
                eventDispatcher.loadCanceled( null,
                        DATA_TYPE_MEDIA, 0,null, 0, null, 0, 0);
            }
        }
    }
    ...
    public void onMediaStreamPlaybackComplete(RtspSampleStreamWrapper sampleStream) {
        synchronized (this) {
            ...
            if (preparedSampleStreamWrappers.length == 0) {
                ...
                eventDispatcher.loadCompleted(null,
                        DATA_TYPE_MEDIA, 0, null, 0, null, 0, 0);
            }
        }
    }
...
*/
        ...
        eventDispatcher.loadStarted(null, DATA_TYPE_MEDIA, 0, null, 0, null, 0,
