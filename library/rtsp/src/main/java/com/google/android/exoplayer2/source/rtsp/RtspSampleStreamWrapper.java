...
public final class RtspSampleStreamWrapper implements
    ...
    /* package */ abstract class MediaStreamLoadable implements Loader.Loadable {
        ...
        private void openInternal() throws IOException {
            ...
            } catch (UnsupportedFormatException | NullPointerException | InterruptedException ex) {
                maybeFailureOpen();
                throw new IOException();
            }
        }
        ...
        protected int readInternal(PositionHolder seekPosition) throws IOException {
            return extractor.read(extractorInput, seekPosition);
        }

        protected void seekInternal(long timeUs) throws IOException {
        ...
        abstract void loadMedia() throws IOException;
    }
